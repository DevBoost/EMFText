...
public class Cct5CopiedEObjectInternalEList extends org.emftext.test.cct5.resource.cct5.util.Cct5CopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public Cct5CopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);
