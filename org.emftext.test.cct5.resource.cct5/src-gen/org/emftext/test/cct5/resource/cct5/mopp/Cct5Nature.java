...
public class Cct5Nature implements IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.test.cct5.resource.cct5.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.test.cct5.resource.cct5.mopp.Cct5BuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.test.cct5.resource.cct5.mopp.Cct5BuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
