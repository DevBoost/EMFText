...
public class gUnitParser extends Parser {
    ...
    public final void suite() throws RecognitionException {
        ...
        try {
            ...
            match(input,26,FOLLOW_26_in_suite120); 
            		...
            		if ( r2==null ) {
            			ts = new gUnitSuite((r1!=null?r1.getText():null));
            		}
            		else {
            			ts = new gUnitSuite((r1!=null?r1.getText():null), (r2!=null?r2.getText():null));
            		}
    ...
    public final void test(gUnitSuite ts) throws RecognitionException {
        Token ok=null;
        Token fail=null;
        Token RETVAL5=null;
        ...
        try {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    ts.testSuites.put(new gUnitTestInput((input2!=null?input2.testInput:null), (input2!=null?input2.inputIsFile:false), (input2!=null?input2.line:0)), new BooleanTestCase(true));
                ...
                case 2 :
                    ...
                    ts.testSuites.put(new gUnitTestInput((input3!=null?input3.testInput:null), (input3!=null?input3.inputIsFile:false), (input3!=null?input3.line:0)), new BooleanTestCase(false));
                ...
                case 3 :
                    ...
                    ts.testSuites.put(new gUnitTestInput((input4!=null?input4.testInput:null), (input4!=null?input4.inputIsFile:false), (input4!=null?input4.line:0)), new ReturnTestCase(RETVAL5));
                ...
                case 4 :
                    ...
                    ts.testSuites.put(new gUnitTestInput((input6!=null?input6.testInput:null), (input6!=null?input6.inputIsFile:false), (input6!=null?input6.line:0)), new OutputTestCase(output7));
