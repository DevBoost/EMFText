...
/**
 * This is the item provider adapter for a {@link org.emftext.sdk.concretesyntax.RegexPart} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegexPartItemProvider
	 ...
	 * @generated
	 */
	public RegexPartItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((RegexPart)object).getRegex();
		return label == null || label.length() == 0 ?
			getString("_UI_RegexPart_type") :
			getString("_UI_RegexPart_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(RegexPart.class)) {
