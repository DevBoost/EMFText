...
public class ANTLRv3Parser extends Parser {
    ...
    public final ANTLRv3Parser.grammarDef_return grammarDef() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: id, tokensSpec, attrScope, optionsSpec, DOC_COMMENT, rule, action
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final ANTLRv3Parser.rule_return rule() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: altList, optionsSpec, arg, ruleAction, throwsSpec, rt, ruleScopeSpec, RET, id, exceptionGroup
            // token labels: arg, rt
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
                ...
                case 2 :
                    ...
                    switch (alt42) {
                        case 1 :
                            ...
                            // AST REWRITE
                            // elements: block, labelOp, id, ebnfSuffix
                            // token labels: labelOp
                            // rule labels: retval
                            // token list labels: 
                            // rule list labels: 
