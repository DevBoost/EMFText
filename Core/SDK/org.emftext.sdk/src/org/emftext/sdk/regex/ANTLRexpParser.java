...
public class ANTLRexpParser extends Parser {
	...
	public String[] getTokenNames() {
		return ANTLRexpParser.TOKEN_NAMES;
	}
	...
	public java.util.List<RecognitionException> recExceptions = ((ANTLRexpLexer) getTokenStream()
			.getTokenSource()).lexerExceptions;

	// $ANTLR start "root"
	// ANTLRexp.g:112:1: root returns [StringBuffer buf] : alternative1=
	...
	public final StringBuffer root() throws RecognitionException {
		...
		try {
			// ANTLRexp.g:118:1: (alternative1= alternative ( '|' alternative2=
			// alternative )* EOF )
			// ANTLRexp.g:118:3: alternative1= alternative ( '|' alternative2=
			// alternative )* EOF
			{
	...
	// $ANTLR start "ebnf"
	// ANTLRexp.g:122:1: ebnf returns [StringBuffer buf] : bl= block (sign= '?'
	// | sign= '*' | sign= '+' | sign= '^' | sign= '!' )? ;
	public final StringBuffer ebnf() throws RecognitionException {
		...
		try {
			// ANTLRexp.g:127:1: (bl= block (sign= '?' | sign= '*' | sign= '+' |
			// sign= '^' | sign= '!' )? )
			// ANTLRexp.g:127:3: bl= block (sign= '?' | sign= '*' | sign= '+' |
			// sign= '^' | sign= '!' )?
			{
				...
				buf.append(bl);
				// ANTLRexp.g:127:38: (sign= '?' | sign= '*' | sign= '+' | sign=
				// '^' | sign= '!' )?
				int alt2 = 6;
				switch (input.LA(1)) {
				case 11: {
	...
	// $ANTLR start "range"
	// ANTLRexp.g:135:1: range returns [StringBuffer buf] : first= CHAR_LITERAL
	// '..' second= CHAR_LITERAL ;
	...
	// ANTLRexp.g:149:1: terminal returns [StringBuffer buf] : (signTerminal=
	// CHAR_LITERAL | signTerminal= STRING_LITERAL | signTerminalDot= '.' ) ;
	public final StringBuffer terminal() throws RecognitionException {
		...
		try {
			// ANTLRexp.g:155:1: ( (signTerminal= CHAR_LITERAL | signTerminal=
			// STRING_LITERAL | signTerminalDot= '.' ) )
			// ANTLRexp.g:155:5: (signTerminal= CHAR_LITERAL | signTerminal=
			// STRING_LITERAL | signTerminalDot= '.' )
			{
				// ANTLRexp.g:155:5: (signTerminal= CHAR_LITERAL | signTerminal=
				// STRING_LITERAL | signTerminalDot= '.' )
	...
	// ANTLRexp.g:166:1: ebnfSuffix returns [StringBuffer buf] : (sign= '?' |
	// sign= '*' | sign= '+' ) ;
	...
	// $ANTLR start "block"
	// ANTLRexp.g:181:1: block returns [StringBuffer buf] : '(' alternative1=
	...
	public final StringBuffer block() throws RecognitionException {
		...
		try {
			// ANTLRexp.g:187:1: ( '(' alternative1= alternative ( '|'
			// alternative2= alternative )* ')' )
			// ANTLRexp.g:187:5: '(' alternative1= alternative ( '|'
			// alternative2= alternative )* ')'
			{
	...
	// $ANTLR start "element"
	// ANTLRexp.g:197:1: element returns [StringBuffer buf] : ele=
	// elementNoOptionSpec ;
	...
	// ANTLRexp.g:208:1: elementNoOptionSpec returns [StringBuffer buf] : (at=
	// atom (suf= ebnfSuffix )? | eb= ebnf );
	...
	// $ANTLR start "atom"
	// ANTLRexp.g:225:1: atom returns [StringBuffer buf] : (exp= range | exp=
	// terminal | exp= notSet ) (sign= '^' | sign= '!' )? ;
	public final StringBuffer atom() throws RecognitionException {
		...
		try {
			// ANTLRexp.g:230:1: ( (exp= range | exp= terminal | exp= notSet )
			// (sign= '^' | sign= '!' )? )
	...
	// $ANTLR start "notSet"
	// ANTLRexp.g:239:1: notSet returns [StringBuffer buf] : sign= '~' (bl=
	// block ) ;
