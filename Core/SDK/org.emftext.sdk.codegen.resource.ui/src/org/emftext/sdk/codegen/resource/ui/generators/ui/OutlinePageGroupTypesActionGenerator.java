...
public class OutlinePageGroupTypesActionGenerator extends UIJavaBaseGenerator<ArtifactParameter<GenerationContext>> {
	...
	private void addConstructor(JavaComposite sc) {
		...
		sc.add("super(treeViewer, \"Group types\", " + I_ACTION(sc) + ".AS_CHECK_BOX);");
		sc.add("initialize(\"" + UIConstants.DEFAULT_ICON_DIR + "/" + UIConstants.Icon.DEFAULT_GROUP_TYPES_ICON.getFilename() + "\");");
		sc.add("}");
		sc.addLineBreak();
	}
	...
	private void addRunInternalMethod(JavaComposite sc) {
		...
		sc.add("getTreeViewerComparator().setGroupTypes(on);");
