 ...
 */
public class Cct5BackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final org.emftext.test.cct5.resource.cct5.ICct5TextResource resource, final org.emftext.test.cct5.resource.cct5.ui.Cct5Editor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final org.emftext.test.cct5.resource.cct5.ICct5TextResource resource, final org.emftext.test.cct5.resource.cct5.ui.Cct5Editor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.test.cct5.resource.cct5.ICct5TextResource resource, final org.emftext.test.cct5.resource.cct5.ui.Cct5Editor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.test.cct5.resource.cct5.mopp.Cct5Resource) {
							org.emftext.test.cct5.resource.cct5.mopp.Cct5Resource concreteResource = (org.emftext.test.cct5.resource.cct5.mopp.Cct5Resource) resource;
