 ...
 */
public class Cct5ImageProvider {
	
	public final static Cct5ImageProvider INSTANCE = new Cct5ImageProvider();
	...
	public ImageDescriptor getImageDescriptor(String key) {
		...
		if (ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.emftext.test.cct5.resource.cct5.ui.Cct5UIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}
