 ...
 */
public class Cct5CompletionProposal implements Comparable<Cct5CompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.emftext.test.cct5.resource.cct5.mopp.Cct5ExpectedTerminal expectedTerminal;
	...
	public Cct5CompletionProposal(org.emftext.test.cct5.resource.cct5.mopp.Cct5ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public Cct5CompletionProposal(org.emftext.test.cct5.resource.cct5.mopp.Cct5ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public Cct5CompletionProposal(org.emftext.test.cct5.resource.cct5.mopp.Cct5ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.emftext.test.cct5.resource.cct5.mopp.Cct5ExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof Cct5CompletionProposal) {
			Cct5CompletionProposal other = (Cct5CompletionProposal) object;
	...
	public int compareTo(Cct5CompletionProposal object) {
		if (object instanceof Cct5CompletionProposal) {
			Cct5CompletionProposal other = (Cct5CompletionProposal) object;
