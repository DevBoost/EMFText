...
public class Cct5BracketSet {
	...
	private ArrayList<org.emftext.test.cct5.resource.cct5.ICct5BracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public Cct5BracketSet() {
		super();
		this.languageID = new org.emftext.test.cct5.resource.cct5.mopp.Cct5MetaInformation().getSyntaxName();
		this.bracketPairs = new ArrayList<org.emftext.test.cct5.resource.cct5.ICct5BracketPair>();
	}
	...
	public org.emftext.test.cct5.resource.cct5.ICct5BracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public org.emftext.test.cct5.resource.cct5.ICct5BracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.test.cct5.resource.cct5.ICct5BracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new org.emftext.test.cct5.resource.cct5.mopp.Cct5BracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.test.cct5.resource.cct5.ICct5BracketPair remove(String opening, String closing) {
		for (org.emftext.test.cct5.resource.cct5.ICct5BracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<org.emftext.test.cct5.resource.cct5.ICct5BracketPair>();
	...
	public void highlightBrackets(IDocument document, int position, int caretOffset) {
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
