 ...
 * @since 3.2
 */
public class Cct5BrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput fInput;
	 ...
	 */
	public Cct5BrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public Cct5BrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public Cct5BrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput);
		...
		fInput= (org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput) input;
		...
		org.emftext.test.cct5.resource.cct5.ui.Cct5HTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.test.cct5.resource.cct5.ui.Cct5HTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput getInput() {
		return fInput;
	}
