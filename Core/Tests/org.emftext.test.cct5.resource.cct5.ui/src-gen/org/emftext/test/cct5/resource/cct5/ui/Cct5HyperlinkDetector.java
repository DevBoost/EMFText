 ...
 * hovers, is a proxy.
 */
public class Cct5HyperlinkDetector implements IHyperlinkDetector {
	 ...
	 */
	public Cct5HyperlinkDetector(Resource resource) {
		textResource = (org.emftext.test.cct5.resource.cct5.ICct5TextResource) resource;
	}
		...
		for (EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					IHyperlink hyperlink = new org.emftext.test.cct5.resource.cct5.ui.Cct5Hyperlink(new Region(offset, length), resolvedEObject, text);
