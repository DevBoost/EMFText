 ...
 */
public class Cct5Highlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private org.emftext.test.cct5.resource.cct5.ui.Cct5Editor editor;
	private ProjectionViewer projectionViewer;
	private org.emftext.test.cct5.resource.cct5.ui.Cct5Occurrence occurrence;
	private org.emftext.test.cct5.resource.cct5.ui.Cct5BracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.emftext.test.cct5.resource.cct5.ICct5BackgroundParsingListener {
	 ...
	 */
	public Cct5Highlighting(org.emftext.test.cct5.resource.cct5.ICct5TextResource textResource, ProjectionViewer projectionViewer, org.emftext.test.cct5.resource.cct5.ui.Cct5ColorManager colorManager, org.emftext.test.cct5.resource.cct5.ui.Cct5Editor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = org.emftext.test.cct5.resource.cct5.ui.Cct5UIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new org.emftext.test.cct5.resource.cct5.ui.Cct5Occurrence(textResource, projectionViewer);
		this.bracketSet = new org.emftext.test.cct5.resource.cct5.ui.Cct5BracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		this.black = colorManager.getColor(new RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.test.cct5.resource.cct5.ui.Cct5Editor editor) {
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.test.cct5.resource.cct5.ui.Cct5EObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
