 ...
 */
public class Cct5ContentAssistPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public Cct5ContentAssistPreferencePage() {
		initialize();
	}
	...
	public void init(IWorkbench workbench) {
		...
		// init values
		assistEnabled = preferenceStore.getBoolean(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED);
		activationDelay = preferenceStore.getInt(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getString(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
	}
	...
	protected void performDefaults() {
		IPreferenceStore preferenceStore = getPreferenceStore();
		assistEnabled = preferenceStore.getDefaultBoolean(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED);
		activationDelay = preferenceStore.getDefaultInt(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getDefaultString(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
		// defaults in widgets
	...
	private boolean updatePreferences() {
		...
		try {
			...
			org.emftext.test.cct5.resource.cct5.mopp.Cct5Plugin.getDefault().getLog().log(			new Status(IStatus.ERROR			, org.emftext.test.cct5.resource.cct5.ui.Cct5UIPlugin.getDefault().getBundle().getSymbolicName()			, "Value '" + delayText + "' is no valid delay value"			, exception)			);
			return false;
		}
		activationTriggers = txtTriggers.getText();
		IPreferenceStore preferenceStore = getPreferenceStore();
		preferenceStore.setValue(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED, assistEnabled);
		preferenceStore.setValue(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY, activationDelay);
		preferenceStore.setValue(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS, activationTriggers);
		return true;
	}
