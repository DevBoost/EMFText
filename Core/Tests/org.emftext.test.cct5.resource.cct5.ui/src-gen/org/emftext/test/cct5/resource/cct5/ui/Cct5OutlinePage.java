 ...
 */
public class Cct5OutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.emftext.test.cct5.resource.cct5.ui.outlinecontext";
	...
	public Cct5OutlinePage(org.emftext.test.cct5.resource.cct5.ICct5ResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new org.emftext.test.cct5.resource.cct5.ui.Cct5OutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof org.emftext.test.cct5.resource.cct5.ui.Cct5OutlinePageTreeViewer) {
								org.emftext.test.cct5.resource.cct5.ui.Cct5OutlinePageTreeViewer pageTreeViewer = (org.emftext.test.cct5.resource.cct5.ui.Cct5OutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new org.emftext.test.cct5.resource.cct5.ui.Cct5OutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.emftext.test.cct5.resource.cct5.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new org.emftext.test.cct5.resource.cct5.ui.Cct5OutlinePageActionProvider().getActions(treeViewer);
