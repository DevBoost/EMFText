...
SYNTAXDEF scrava
FOR <http://hal.no/scrava> <scrava.genmodel>
START 	//scrava.ModuleCompilationUnit
		containers.CompilationUnit
		//,containers.Package, containers.EmptyModel

IMPORTS {
//	java : <http://www.emftext.org/java> WITH SYNTAX java <platform:/plugin/org.emftext.language.java/metamodel/java.cs>
	scrava : <http://hal.no/scrava>
...
//		(!1
//			statements |
//			members:members.Field,members.Method,classifiers.ConcreteClassifier
//		)+
//		!0
//       ("\\u001a")?
//	;
...
containers.CompilationUnit 
   ::=	("package" namespaces[] (#0 "." #0 namespaces[])* #0 ";" )?
        ...
        (";" !0)*
        !0
        classifiers:scrava.ModuleClass
        ("\\u001a")?
	;
...
scrava.ModuleClass
   ::=	(!1
			statements |
			members:members.Field,members.Method,classifiers.Class,classifiers.Enumeration
		)+
	;

scrava.SimpleEnumConstant ::= name[]
    ;
...
classifiers.Enumeration
    ::= annotationsAndModifiers*
    	...
    	// ("implements" (implements ("," implements)*))? 
    	"{" 
    		(!1 constants:scrava.SimpleEnumConstant ("," !1 constants:scrava.SimpleEnumConstant)*)? (",")?
    		// (";" (!1 members)* !0)?
    	"}"
    ;
...
//     ::= // annotations*
//    	name[] ("(" (arguments:expressions.AssignmentExpression ("," arguments:expressions.AssignmentExpression)*)? ")" )?
//    	(anonymousClass)?
//    ;
...
members.ClassMethod
	::=	annotationsAndModifiers* 
	// ("<" #0 typeParameters (#0 "," typeParameters)* #0 ">")?
	(typeReference arrayDimensionsBefore*) name[]  
	"(" #0 (parameters ("," parameters)* )? #0 ")" arrayDimensionsAfter*
	("throws" exceptions ("," exceptions)*)? "{" (!1 statements)* !0 "}"
	;
...
parameters.OrdinaryParameter
	::= // annotationsAndModifiers*
	typeReference arrayDimensionsBefore* ("<" typeArguments ("," typeArguments)* ">")? name[] arrayDimensionsAfter*
	;

parameters.VariableLengthParameter
	::= // annotationsAndModifiers*
	typeReference arrayDimensionsBefore* ("<" typeArguments ("," typeArguments)* ">")? "..." name[] 
	;

variables.LocalVariable
	::= // annotationsAndModifiers*
	typeReference arrayDimensionsBefore* ("<" typeArguments ("," typeArguments)* ">")? name[] arrayDimensionsAfter* ("=" initialValue:expressions.AssignmentExpression)? ("," additionalLocalVariables)*
	;
