 ...
 * @generated
 */
public class Cct5Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Cct5Package.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Cct5Package.FARMER: {
				Farmer farmer = (Farmer)theEObject;
				T result = caseFarmer(farmer);
				if (result == null) result = caseNamedElement(farmer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Cct5Package.DIET: {
				Diet diet = (Diet)theEObject;
				T result = caseDiet(diet);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Cct5Package.ANIMAL: {
				Animal animal = (Animal)theEObject;
				T result = caseAnimal(animal);
				if (result == null) result = caseNamedElement(animal);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Cct5Package.FARM: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Diet</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Diet</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDiet(Diet object) {
		return null;
	}
