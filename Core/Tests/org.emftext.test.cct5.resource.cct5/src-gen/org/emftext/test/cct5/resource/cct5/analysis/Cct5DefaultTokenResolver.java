 ...
 * </p>
 */
public class Cct5DefaultTokenResolver implements org.emftext.test.cct5.resource.cct5.ICct5TokenResolver {
	 ...
	 */
	public Cct5DefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public Cct5DefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, org.emftext.test.cct5.resource.cct5.ICct5TokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.test.cct5.resource.cct5.grammar.Cct5GrammarInformationProvider.INSTANCE.getKeywords()) {
