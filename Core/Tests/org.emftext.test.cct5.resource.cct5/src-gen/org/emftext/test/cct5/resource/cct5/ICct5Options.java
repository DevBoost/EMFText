 ...
 */
public interface ICct5Options {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.emftext.test.cct5.resource.cct5.mopp.Cct5MetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.emftext.test.cct5.resource.cct5.mopp.Cct5MetaInformation().getResourcePostProcessorProviderOptionKey();
