	...
	public static <K> void putAndMergeKeys(Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof List<?>) {
				...
				List<Object> currentValueAsObjectList = org.emftext.test.cct5.resource.cct5.util.Cct5ListUtil.copySafelyToObjectList(currentValueAsList);
