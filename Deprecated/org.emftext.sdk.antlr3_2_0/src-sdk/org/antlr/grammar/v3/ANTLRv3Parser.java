// $ANTLR ${project.version} ${buildNumber} ./ANTLRv3.g 2009-12-16 22:10:36
...
import org.antlr.runtime3_2_0.ParserRuleReturnScope;
...
import org.antlr.runtime3_2_0.tree.CommonTreeAdaptor;
import org.antlr.runtime3_2_0.tree.RewriteEarlyExitException;
import org.antlr.runtime3_2_0.tree.RewriteRuleSubtreeStream;
import org.antlr.runtime3_2_0.tree.RewriteRuleTokenStream;
...
public class ANTLRv3Parser extends Parser {
    ...
    public final ANTLRv3Parser.grammarDef_return grammarDef() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: rule, id, action, DOC_COMMENT, attrScope, optionsSpec, tokensSpec
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final ANTLRv3Parser.rule_return rule() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: exceptionGroup, throwsSpec, RET, altList, arg, id, ruleScopeSpec, rt, optionsSpec, ruleAction
            // token labels: arg, rt
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt57) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: elementOptions, 87, block
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
        ...
        try {
            ...
            if ( (LA59_0==88) ) {
                ...
                if ( (LA59_1==TOKEN_REF) ) {
                    ...
                    if ( (LA59_3==LABEL_ASSIGN) ) {
                        alt59=2;
                    }
                    else if ( ((LA59_3>=89 && LA59_3<=90)) ) {
                        alt59=1;
                    }
                    else {
                        if (state.backtracking>0) {state.failed=true; return retval;}
