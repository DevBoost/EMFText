...
// </ul>
//
public class GeneratorconfigBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {

	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };

	private String BRACKETS_COLOR = org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigMetaInformation().getSyntaxName();

	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBracketSet bracketsTmp;

	//
	// Creates a preference page for bracket setting.
	//
	public GeneratorconfigBracketPreferencePage() {
		super();

		org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigMetaInformation metaInformation = new org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		...
		bracketsTmp = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(		org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(		language + org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor) {
			((org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor) editor).invalidateTextRepresentation();
		}
	}
