...
// </ul>
//
public class GeneratorconfigOccurrencePreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private void initializeValues() {
		boolean enable = getPreferenceStore().getBoolean(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		enableCheckbox.setSelection(enable);

		defColorButton.setEnabled(enable);
		org.eclipse.swt.graphics.RGB rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_DEFINITION_COLOR);
		defColorSelector.setColorValue(rgb);

		useColorButton.setEnabled(enable);
		rgb = org.eclipse.jface.preference.PreferenceConverter.getColor(getPreferenceStore(), org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_PROXY_COLOR);
		useColorSelector.setColorValue(rgb);
	}

	// Set the default values for this preference page.
	protected void performDefaults() {
		boolean enable = getPreferenceStore().getDefaultBoolean(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		enableCheckbox.setSelection(enable);
		defColorButton.setEnabled(enable);
		useColorButton.setEnabled(enable);
		defColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_DEFINITION_COLOR));
		useColorSelector.setColorValue(org.eclipse.jface.preference.PreferenceConverter.getDefaultColor(getPreferenceStore(), org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_PROXY_COLOR));
	}
	...
	private void updateActiveEditor() {
		getPreferenceStore().setValue(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX, enableCheckbox.getSelection());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_DEFINITION_COLOR, defColorSelector.getColorValue());
		org.eclipse.jface.preference.PreferenceConverter.setValue(getPreferenceStore(), org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_PROXY_COLOR, useColorSelector.getColorValue());
