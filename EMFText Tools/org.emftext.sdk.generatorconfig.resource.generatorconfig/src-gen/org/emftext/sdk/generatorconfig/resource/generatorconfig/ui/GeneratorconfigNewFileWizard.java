...
public class GeneratorconfigNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {

	private String categoryId = null;
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;

	public GeneratorconfigNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigMetaInformation().getSyntaxName();
	}
