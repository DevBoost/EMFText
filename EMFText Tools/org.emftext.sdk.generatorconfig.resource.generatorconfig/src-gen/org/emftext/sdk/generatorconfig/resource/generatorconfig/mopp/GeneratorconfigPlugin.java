...
public class GeneratorconfigPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {

	public static final String PLUGIN_ID = "org.emftext.sdk.generatorconfig.resource.generatorconfig";
	...
	private static GeneratorconfigPlugin plugin;

	public GeneratorconfigPlugin() {
		super();
	}
	...
	public static GeneratorconfigPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GeneratorconfigPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GeneratorconfigPlugin.PLUGIN_ID, message);
		}
		final GeneratorconfigPlugin pluginInstance = GeneratorconfigPlugin.getDefault();
