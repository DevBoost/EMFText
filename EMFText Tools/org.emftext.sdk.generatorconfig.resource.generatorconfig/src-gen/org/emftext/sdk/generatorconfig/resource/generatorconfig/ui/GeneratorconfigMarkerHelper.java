...
// If a resource contains <code>org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextDiagnostic</code>s it uses the more precise information of
// this extended diagnostic type.
public class GeneratorconfigMarkerHelper {

	public static final String MARKER_TYPE = org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.PLUGIN_ID + ".problem";
	...
	private static void createMarkersFromDiagnostics(org.eclipse.emf.ecore.resource.Resource resource, org.eclipse.core.resources.IFile file, java.util.List<org.eclipse.emf.ecore.resource.Resource.Diagnostic> diagnostics, int markerSeverity) throws org.eclipse.core.runtime.CoreException {
		...
		for (org.eclipse.emf.ecore.resource.Resource.Diagnostic diagnostic : diagnostics) {
			try {
				...
				if (diagnostic instanceof org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextDiagnostic) {
					org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextDiagnostic textDiagnostic = (org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextDiagnostic) diagnostic;
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) throws org.eclipse.core.runtime.CoreException {
		org.eclipse.core.resources.IFile file = (org.eclipse.core.resources.IFile) org.eclipse.core.resources.ResourcesPlugin.getWorkspace().getRoot().findMember(resource.getURI().toPlatformString(true));
		if (file != null) {
			file.deleteMarkers(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigMarkerHelper.MARKER_TYPE, false, org.eclipse.core.resources.IResource.DEPTH_ZERO);
		}
	}
}
