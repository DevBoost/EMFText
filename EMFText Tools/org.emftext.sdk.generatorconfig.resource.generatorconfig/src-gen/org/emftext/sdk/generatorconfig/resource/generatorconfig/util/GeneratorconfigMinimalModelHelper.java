...
// models.
//
public class GeneratorconfigMinimalModelHelper {

	private final static org.emftext.sdk.generatorconfig.resource.generatorconfig.util.GeneratorconfigEClassUtil eClassUtil = new org.emftext.sdk.generatorconfig.resource.generatorconfig.util.GeneratorconfigEClassUtil();
			...
			if (feature instanceof org.eclipse.emf.ecore.EReference) {
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.emftext.sdk.generatorconfig.resource.generatorconfig.util.GeneratorconfigStringUtil.capitalize(typeClass.getName());
						...
						if (value instanceof java.util.List<?>) {
							java.util.List<org.eclipse.emf.ecore.EObject> list = org.emftext.sdk.generatorconfig.resource.generatorconfig.util.GeneratorconfigListUtil.castListUnchecked(value);
							list.add(subModel);
						} else {
				...
				if ("EString".equals(attribute.getEType().getName())) {
					...
					if(attribute.getName().equals("name") && name != null) {
						...
						initialValue = "some" + org.emftext.sdk.generatorconfig.resource.generatorconfig.util.GeneratorconfigStringUtil.capitalize(attribute.getName());
					}
					java.lang.Object value = root.eGet(attribute);
					if (value instanceof java.util.List<?>) {
						java.util.List<String> list = org.emftext.sdk.generatorconfig.resource.generatorconfig.util.GeneratorconfigListUtil.castListUnchecked(value);
