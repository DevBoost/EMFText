...
public class GeneratorconfigResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	public GeneratorconfigResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
		...
		if (factories.get("") == null) {
			factories.put("", new org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigResourceFactory());
		}
	}
