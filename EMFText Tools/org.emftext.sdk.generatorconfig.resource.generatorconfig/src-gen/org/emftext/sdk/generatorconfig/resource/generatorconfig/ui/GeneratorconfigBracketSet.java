...
public class GeneratorconfigBracketSet {
	...
	private java.util.ArrayList<org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair> bracketPairs;
	...
	private class BracketPair implements org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	...
	public GeneratorconfigBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String extension) {
		languageID = extension;
		this.bracketPairs = new java.util.ArrayList<org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair>();
	...
	public org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair getBracketPair(int index) {
		try {
	...
	public boolean setClosingEnabledInside(org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	public org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair remove(String opening, String closing) {
		for (org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
