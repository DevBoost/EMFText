...
// encoding conversion.
//
public interface IGeneratorconfigInputStreamProcessorProvider {

	// Return a processor for the given input stream.
	//
	// @param inputStream the actual stream that provides the content of a resource
	// @return a processor that pre-processes the input stream
	public org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}
