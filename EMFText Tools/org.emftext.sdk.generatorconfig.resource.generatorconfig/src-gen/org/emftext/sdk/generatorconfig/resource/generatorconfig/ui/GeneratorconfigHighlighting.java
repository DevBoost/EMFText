...
public class GeneratorconfigHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionHelper positionHelper = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigTokenScanner scanner;
	...
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigOccurrence occurrence;
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBracketSet bracketSet;
	...
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBackgroundParsingListener {
	...
	public GeneratorconfigHighlighting(org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigColorManager colorManager, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigTokenScanner(colorManager);
		occurrence = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBracketSet(sourceviewer, "generatorconfig");
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));

		addListeners(editor);
	}

	private void addListeners(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.PROXY.toString());
		}
	}

	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.DEFINTION.toString()) || category.equals(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.PROXY.toString()));
		if (category.equals(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	private void handleContentOutlineSelection(org.eclipse.jface.viewers.ISelection selection) {
		if (!selection.isEmpty()) {
			...
			if (selectedElement instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (resource instanceof org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource) {
