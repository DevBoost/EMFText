...
public class GeneratorconfigBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource resource, final org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor editor) {
		if (resource == null) {
			return;
		}
