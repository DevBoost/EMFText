...
public class GeneratorconfigNature implements org.eclipse.core.resources.IProjectNature {

	public static final String NATURE_ID = "org.emftext.sdk.generatorconfig.resource.generatorconfig.nature";

	private org.eclipse.core.resources.IProject project;

	// the IDs of all builders, IDs of additional builders can be added here
	public final static String[] BUILDER_IDS = {org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
