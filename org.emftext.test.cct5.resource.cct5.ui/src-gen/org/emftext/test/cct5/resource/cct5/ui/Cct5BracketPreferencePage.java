 ...
 * </p>
 */
public class Cct5BracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new org.emftext.test.cct5.resource.cct5.mopp.Cct5MetaInformation().getSyntaxName();
	
	private org.emftext.test.cct5.resource.cct5.ui.Cct5BracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public Cct5BracketPreferencePage() {
		super();
		
		org.emftext.test.cct5.resource.cct5.ICct5MetaInformation metaInformation = new org.emftext.test.cct5.resource.cct5.mopp.Cct5MetaInformation();
	...
	public void init(IWorkbench workbench) {
		...
		bracketsTmp = new org.emftext.test.cct5.resource.cct5.ui.Cct5BracketSet();
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.deserialize(getPreferenceStore().getString(language + org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_BRACKETS_SUFFIX));
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				org.emftext.test.cct5.resource.cct5.ICct5BracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected void performDefaults() {
		...
		enableCheckbox.setSelection(preferenceStore.getDefaultBoolean(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		matchingBracketsColorEditor.setColorValue(PreferenceConverter.getDefaultColor(preferenceStore, BRACKETS_COLOR));
		String defaultBrackets = preferenceStore.getDefaultString(language + org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	private void updateActiveEditor() {
		...
		preferenceStore.setValue(org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		preferenceStore.setValue(language + org.emftext.test.cct5.resource.cct5.ui.Cct5PreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		IWorkbench workbench = org.eclipse.ui.PlatformUI.getWorkbench();
		IEditorPart editor = workbench.getActiveWorkbenchWindow().getActivePage().getActiveEditor();
		if (editor != null && editor instanceof org.emftext.test.cct5.resource.cct5.ui.Cct5Editor) {
			((org.emftext.test.cct5.resource.cct5.ui.Cct5Editor) editor).invalidateTextRepresentation();
		}
	}
	
	protected org.emftext.test.cct5.resource.cct5.ICct5BracketPair getSelectedBracketPair() {
