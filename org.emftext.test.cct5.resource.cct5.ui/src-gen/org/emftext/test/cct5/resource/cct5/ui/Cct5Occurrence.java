 ...
 */
public class Cct5Occurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(org.emftext.test.cct5.resource.cct5.ui.ICct5TokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.emftext.test.cct5.resource.cct5.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.emftext.test.cct5.resource.cct5.ui.occurences.declaration";
	
	private final static org.emftext.test.cct5.resource.cct5.ui.Cct5PositionHelper positionHelper = new org.emftext.test.cct5.resource.cct5.ui.Cct5PositionHelper();
	 ...
	 */
	private org.emftext.test.cct5.resource.cct5.ICct5TextResource textResource;
	...
	/**
	 * <p>
	 * Creates a Cct5Occurrence object to find positions to highlight.
	 * </p>
	 * 
	 * @param textResource the text resource for location
	 * @param projectionViewer the viewer for the text
	 */
	public Cct5Occurrence(org.emftext.test.cct5.resource.cct5.ICct5TextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(org.emftext.test.cct5.resource.cct5.ICct5LocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		org.emftext.test.cct5.resource.cct5.ui.ICct5TokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected void addAnnotationsForReferences(EObject referencedElement, List<String> matchingNames) {
		...
		for (Setting setting : referencingObjects) {
			...
			for (String name : matchingNames) {
				...
				if (index > 0) {
					addAnnotation(document, org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory.PROXY, name, index, name.length());
				}
			}
		}
	}
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new org.emftext.test.cct5.resource.cct5.analysis.Cct5DefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(org.emftext.test.cct5.resource.cct5.ui.ICct5TokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		org.emftext.test.cct5.resource.cct5.ui.ICct5TokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected org.emftext.test.cct5.resource.cct5.ui.ICct5TokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		org.emftext.test.cct5.resource.cct5.ICct5LocationMap locationMap = textResource.getLocationMap();
		
		org.emftext.test.cct5.resource.cct5.ui.ICct5TokenScanner tokenScanner = createTokenScanner();
	...
	protected org.emftext.test.cct5.resource.cct5.ui.ICct5TokenScanner createTokenScanner() {
		return new org.emftext.test.cct5.resource.cct5.ui.Cct5UIMetaInformation().createTokenScanner(null, null);
	}
	
	protected void addAnnotation(IDocument document, org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory type, String text, int offset, int length) {
		...
		if (type == org.emftext.test.cct5.resource.cct5.ui.Cct5PositionCategory.DEFINITION) {
	...
	protected void removeAnnotations() {
		removeAnnotations(org.emftext.test.cct5.resource.cct5.ui.Cct5Occurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.emftext.test.cct5.resource.cct5.ui.Cct5Occurrence.DECLARATION_ANNOTATION_ID);
	}
