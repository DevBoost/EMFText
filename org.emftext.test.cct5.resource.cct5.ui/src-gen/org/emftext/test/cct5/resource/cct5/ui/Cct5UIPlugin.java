 ...
 */
public class Cct5UIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.test.cct5.resource.cct5.ui";
	public static final String EDITOR_ID = "org.emftext.test.cct5.resource.cct5.ui.Cct5Editor";
	...
	private static Cct5UIPlugin plugin;
	...
	public static Cct5UIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, Cct5UIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, Cct5UIPlugin.PLUGIN_ID, message);
		}
		final Cct5UIPlugin pluginInstance = Cct5UIPlugin.getDefault();
