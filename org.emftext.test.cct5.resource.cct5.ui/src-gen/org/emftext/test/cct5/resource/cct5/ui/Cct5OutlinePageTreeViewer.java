 ...
 * a specified depth.
 */
public class Cct5OutlinePageTreeViewer extends TreeViewer {
	...
	public Cct5OutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.test.cct5.resource.cct5.ui.Cct5EObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.test.cct5.resource.cct5.mopp.Cct5Plugin.logError("Exception while refreshing outline view", e);
		}
	}
