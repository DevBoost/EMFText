 ...
 * plug-in.
 */
public class Cct5UIResourceBundle {
	
	/**
	 * The title of the NewProjectWizard window.
	 */
	public static String NEW_PROJECT_WIZARD_WINDOW_TITLE = "New cct5 Project";
	
	/**
	 * The name of the main page for the NewProjectWizard.
	 */
	public static String NEW_PROJECT_WIZARD_PAGE_NAME = "Create new cct5 Project";
	 ...
	 */
	public static String NEW_FILE_WIZARD_FILE_NAME = "new_file.cct5";
	
	/**
	 * The title for the NewFileWizard window.
	 */
	public static String NEW_FILE_WIZARD_WINDOW_TITLE = "New cct5 File";
	
	/**
	 * The title for the NewFileWizard page.
	 */
	public static String NEW_FILE_WIZARD_PAGE_TITLE = "Create new cct5 file";
	
	/**
	 * The description for the NewFileWizard.
	 */
	public static String NEW_FILE_WIZARD_DESCRIPTION = "This wizard creates a new file with *.cct5 extension.";
	
	/**
	 * The description for the root preference page.
	 */
	public static String ROOT_PREFERENCE_PAGE_DESCRIPTION = "Cct5 Text Editor Preferences";
	...
	static {
		try {
			ResourceBundle bundle = ResourceBundle.getBundle(Cct5UIResourceBundle.class.getName(), Locale.getDefault());
			if (bundle != null) {
				Set<String> keys = bundle.keySet();
				for (String key : keys) {
					String value = bundle.getString(key);
					try {
						Field field = Cct5UIResourceBundle.class.getDeclaredField(key.toUpperCase());
