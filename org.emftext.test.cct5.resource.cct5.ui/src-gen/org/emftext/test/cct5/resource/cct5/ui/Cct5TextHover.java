 ...
 */
public class Cct5TextHover implements ITextHover, ITextHoverExtension, ITextHoverExtension2 {
	...
	private org.emftext.test.cct5.resource.cct5.ICct5HoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends Action {
		...
		private final org.emftext.test.cct5.resource.cct5.ui.Cct5BrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.test.cct5.resource.cct5.ui.Cct5BrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput infoInput = (org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.test.cct5.resource.cct5.ui.Cct5Hyperlink hyperlink = new org.emftext.test.cct5.resource.cct5.ui.Cct5Hyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			if (org.emftext.test.cct5.resource.cct5.ui.Cct5BrowserInformationControl.isAvailable(parent)) {
				ToolBarManager tbm = new ToolBarManager(SWT.FLAT);
				org.emftext.test.cct5.resource.cct5.ui.Cct5BrowserInformationControl iControl = new org.emftext.test.cct5.resource.cct5.ui.Cct5BrowserInformationControl(parent, FONT, tbm);
				...
				IInputChangedListener inputChangeListener = new IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput) {
							org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput input = (org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends AbstractReusableInformationControlCreator {
		...
		public IInformationControl doCreateInformationControl(Shell parent) {
			...
			if (org.emftext.test.cct5.resource.cct5.ui.Cct5BrowserInformationControl.isAvailable(parent)) {
				org.emftext.test.cct5.resource.cct5.ui.Cct5BrowserInformationControl iControl = new org.emftext.test.cct5.resource.cct5.ui.Cct5BrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public Cct5TextHover(org.emftext.test.cct5.resource.cct5.ICct5ResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.emftext.test.cct5.resource.cct5.ui.Cct5UIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
		...
		return ((org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput internalGetHoverInfo(ITextViewer textViewer, IRegion hoverRegion) {
	 ...
	 */
	private org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput getHoverInfo(List<EObject> elements, ITextViewer textViewer, org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.test.cct5.resource.cct5.ui.Cct5HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.emftext.test.cct5.resource.cct5.ui.Cct5HTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.test.cct5.resource.cct5.ui.Cct5HTMLPrinter.insertPageProlog(buffer, 0, org.emftext.test.cct5.resource.cct5.ui.Cct5TextHover.getStyleSheet());
			org.emftext.test.cct5.resource.cct5.ui.Cct5HTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.test.cct5.resource.cct5.ui.Cct5DocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.emftext.test.cct5.resource.cct5.ui.Cct5HTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		Bundle bundle = Platform.getBundle(org.emftext.test.cct5.resource.cct5.ui.Cct5UIPlugin.PLUGIN_ID);
		URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.emftext.test.cct5.resource.cct5.util.Cct5StreamUtil.getContent(styleSheetURL.openStream());
