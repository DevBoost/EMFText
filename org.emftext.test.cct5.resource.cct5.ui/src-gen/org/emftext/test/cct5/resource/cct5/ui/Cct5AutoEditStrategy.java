...
/**
 * The Cct5AutoEditStrategy extends the default auto edit strategy such that an
 ...
 */
public class Cct5AutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private org.emftext.test.cct5.resource.cct5.ui.Cct5BracketSet bracketSet;
	
	public Cct5AutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new org.emftext.test.cct5.resource.cct5.ui.Cct5BracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(org.emftext.test.cct5.resource.cct5.ui.Cct5BracketSet bracketSet) {
