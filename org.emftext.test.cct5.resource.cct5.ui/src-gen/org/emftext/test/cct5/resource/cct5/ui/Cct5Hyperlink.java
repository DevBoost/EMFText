 ...
 */
public class Cct5Hyperlink implements IHyperlink {
	 ...
	 */
	public Cct5Hyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.test.cct5.resource.cct5.mopp.Cct5Plugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
