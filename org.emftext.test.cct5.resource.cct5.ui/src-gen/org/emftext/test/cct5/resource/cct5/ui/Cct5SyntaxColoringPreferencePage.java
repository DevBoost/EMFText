 ...
 * </p>
 */
public class Cct5SyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public Cct5SyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.test.cct5.resource.cct5.ui.Cct5SyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		org.emftext.test.cct5.resource.cct5.ui.Cct5PixelConverter pixelConverter = new org.emftext.test.cct5.resource.cct5.ui.Cct5PixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.test.cct5.resource.cct5.ui.Cct5Editor) {
			org.emftext.test.cct5.resource.cct5.ui.Cct5Editor emfTextEditor = (org.emftext.test.cct5.resource.cct5.ui.Cct5Editor) editor;
