...
public class OccurrencePreferencePageGenerator extends UIJavaBaseGenerator {

	public static final GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new OccurrencePreferencePageGenerator());

	private OccurrencePreferencePageGenerator() {
		super();
	}

	private OccurrencePreferencePageGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceUIArtifacts.OCCURRENCE_PREFERENCE_PAGE);
	}
