...
public class OccurrenceGenerator extends UIJavaBaseGenerator {

	public static final GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new OccurrenceGenerator());

	private OccurrenceGenerator() {
		super();
	}

	private OccurrenceGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceUIArtifacts.OCCURENCE);
	}
	...
	public IGenerator<GenerationContext, Object> newInstance(ICodeGenerationComponent parent, GenerationContext context, Object parameters) {
		return new OccurrenceGenerator(parent, context);
	}
}
