...
public class EObjectUtilGenerator extends BaseGenerator {
	...
	public boolean generate(PrintWriter out) {
		...
		sc.add(getClassNameHelper().getEMFTEXT_RUNTIME_PLUGIN() + ".logError(\"" + EXCEPTION + " while matching proxy URI.\", e);");
