...
public class ResourcePluginContentCreator {
	...
	public void generate(GenerationContext context, IProgressMonitor monitor) throws IOException {
	    ...
	    creators.add(new GenericArtifactCreator(EArtifact.LAYOUT_INFORMATION));
	    creators.add(new GenericArtifactCreator(EArtifact.LAYOUT_INFORMATION_ADAPTER));
	    ...
	    creators.add(new GenericArtifactCreator(EArtifact.COMPOUND));
	    ...
	    creators.add(new GenericArtifactCreator(EArtifact.ATTRIBUTE_VALUE_PROVIDER));
