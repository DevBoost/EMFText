...
/**
 * This is the item provider adapter for a {@link org.emftext.language.hedl.Option} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OptionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HedlPackage.Literals.OPTION__KEY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HedlPackage.Literals.OPTION__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		OptionType labelValue = ((Option)object).getKey();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Option.class)) {
			case HedlPackage.OPTION__KEY:
			case HedlPackage.OPTION__VALUE:
	...
	public ResourceLocator getResourceLocator() {
		return hedlEditPlugin.INSTANCE;
	}
