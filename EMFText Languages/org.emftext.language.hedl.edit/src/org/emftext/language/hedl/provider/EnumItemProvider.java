...
/**
 * This is the item provider adapter for a {@link org.emftext.language.hedl.Enum} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HedlPackage.Literals.ENUM__LITERALS);
		}
	...
	public String getText(Object object) {
		String name = ((org.emftext.language.hedl.Enum)object).getName();
		return name;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(org.emftext.language.hedl.Enum.class)) {
			case HedlPackage.ENUM__COMMENT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case HedlPackage.ENUM__LITERALS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HedlPackage.Literals.ENUM__LITERALS,
				 HedlFactory.eINSTANCE.createEnumLiteral()));
	}
