...
public class StaticMemberImportStaticMembersReferenceResolver implements org.emftext.language.java.javabehavior4uml.resource.javabehavior.IJavabehaviorReferenceResolver<org.emftext.language.java.imports.StaticMemberImport, org.emftext.language.java.references.ReferenceableElement> {
	...
	public void resolve(String identifier, org.emftext.language.java.imports.StaticMemberImport container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.java.javabehavior4uml.resource.javabehavior.IJavabehaviorReferenceResolveResult<org.emftext.language.java.references.ReferenceableElement> result) {
		delegate.resolve(identifier, container, reference, position, resolveFuzzy, new org.emftext.language.java.resource.java.IJavaReferenceResolveResult<org.emftext.language.java.references.ReferenceableElement>() {
			...
			public void addQuickFix(final org.emftext.language.java.resource.java.IJavaQuickFix quickFix) {
				result.addQuickFix(new org.emftext.language.java.javabehavior4uml.resource.javabehavior.IJavabehaviorQuickFix() {
