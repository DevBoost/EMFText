 ...
 * @generated
 */
public class ValueflowViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = ValueflowVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = ValueflowVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
		...
		return AgentEditPart.VISUAL_ID == visualID
				|| GiveStateEditPart.VISUAL_ID == visualID
				|| TakeStateEditPart.VISUAL_ID == visualID;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		switch (visualID) {
		case AgentEditPart.VISUAL_ID:
			return createAgent_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case GiveStateEditPart.VISUAL_ID:
			return createGiveState_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case TakeStateEditPart.VISUAL_ID:
			return createTakeState_3002(domainElement, containerView, index,
					persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (ValueflowVisualIDRegistry.getVisualID(elementTypeHint)) {
		case StateNextStateEditPart.VISUAL_ID:
			return createStateNextState_4001(containerView, index, persisted,
					preferencesHint);
		case GiveStateGiveToEditPart.VISUAL_ID:
			return createGiveStateGiveTo_4002(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createAgent_2001(EObject domainElement, View containerView,
		...
		node
				.setType(ValueflowVisualIDRegistry
		...
		Node label5003 = createLabel(node, ValueflowVisualIDRegistry
				.getType(AgentNameEditPart.VISUAL_ID));
		createCompartment(node, ValueflowVisualIDRegistry
				.getType(AgentAgentStatesCompartmentEditPart.VISUAL_ID), true,
				false, false, false);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createGiveState_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ValueflowVisualIDRegistry
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5001 = createLabel(node, ValueflowVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createTakeState_3002(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(ValueflowVisualIDRegistry
		...
		ViewUtil.setStructuralFeatureValue(node, NotationPackage.eINSTANCE
				.getFillStyle_FillColor(), FigureUtilities
				.RGBToInteger(fillRGB));
		Node label5002 = createLabel(node, ValueflowVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createStateNextState_4001(View containerView, int index,
		...
		edge.setType(ValueflowVisualIDRegistry
		...
		Node label6001 = createLabel(edge, ValueflowVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createGiveStateGiveTo_4002(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
		...
		Node label6002 = createLabel(edge, ValueflowVisualIDRegistry
