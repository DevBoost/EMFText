 ...
 * @generated
 */
public class ValueflowElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ValueflowElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.ValueflowElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "valueflow".equals(fileExtension); //$NON-NLS-1$
	}
