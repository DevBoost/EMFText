 ...
 * @generated
 */
public class StateNextStateReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public StateNextStateReorientCommand(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setNextState(null);
		getNewSource().setNextState(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setNextState(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
