 ...
 * @generated
 */
public class ValueflowDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ValueflowDomainNavigatorContentProvider() {
		myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(
				ValueflowDiagramEditorPlugin.getInstance()
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ValueflowDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((ValueflowDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ValueflowDomainNavigatorItem(
