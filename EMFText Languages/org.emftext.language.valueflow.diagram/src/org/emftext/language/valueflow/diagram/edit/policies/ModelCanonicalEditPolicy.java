...
import org.emftext.language.valueflow.diagram.part.ValueflowLinkDescriptor;
...
public class ModelCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			int diagramLinkVisualID = ValueflowVisualIDRegistry
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final ValueflowLinkDescriptor nextLinkDescriptor = (ValueflowLinkDescriptor) linkDescriptorsIterator
					.next();
