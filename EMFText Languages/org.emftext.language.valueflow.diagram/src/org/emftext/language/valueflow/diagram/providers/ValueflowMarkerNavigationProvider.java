...
import org.emftext.language.valueflow.diagram.part.ValueflowDiagramEditorUtil;

/**
 * @generated
 */
public class ValueflowMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = ValueflowDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ValueflowDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
