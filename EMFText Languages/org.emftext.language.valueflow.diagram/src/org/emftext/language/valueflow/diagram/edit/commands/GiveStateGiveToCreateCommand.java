 ...
 * @generated
 */
public class GiveStateGiveToCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public GiveStateGiveToCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof GiveState) {
			return false;
		}
		if (target != null && false == target instanceof TakeState) {
			return false;
		}
		if (getSource() == null) {
	 ...
	 * @generated
	 */
	protected GiveState getSource() {
		return (GiveState) source;
	}

	/**
	 * @generated
	 */
	protected TakeState getTarget() {
		return (TakeState) target;
	}
}
