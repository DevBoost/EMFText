...
public class OclNAVIGATION_OPERATORTokenResolver implements org.emftext.language.eocl.resource.eocl.IEoclTokenResolver {
	
	private tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OclNAVIGATION_OPERATORTokenResolver importedResolver = new tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OclNAVIGATION_OPERATORTokenResolver();
