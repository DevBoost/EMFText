...
public class OclSIMPLE_NAMETokenResolver implements org.emftext.language.eocl.resource.eocl.IEoclTokenResolver {
	
	private tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OclSIMPLE_NAMETokenResolver importedResolver = new tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OclSIMPLE_NAMETokenResolver();
