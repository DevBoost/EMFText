...
public class OclMULT_OPERATORTokenResolver implements org.emftext.language.eocl.resource.eocl.IEoclTokenResolver {
	
	private tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OclMULT_OPERATORTokenResolver importedResolver = new tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OclMULT_OPERATORTokenResolver();
	...
	public void resolve(java.lang.String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, final org.emftext.language.eocl.resource.eocl.IEoclTokenResolveResult result) {
		if (feature == EcorePackage.eINSTANCE.getETypedElement_LowerBound() ||
				feature == EcorePackage.eINSTANCE.getETypedElement_UpperBound()) {
			if ("*".equals(lexem)) {
