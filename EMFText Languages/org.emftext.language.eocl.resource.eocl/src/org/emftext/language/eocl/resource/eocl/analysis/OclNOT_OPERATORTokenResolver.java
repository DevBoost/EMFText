...
public class OclNOT_OPERATORTokenResolver implements org.emftext.language.eocl.resource.eocl.IEoclTokenResolver {
	
	private tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OclNOT_OPERATORTokenResolver importedResolver = new tudresden.ocl20.pivot.language.ocl.resource.ocl.analysis.OclNOT_OPERATORTokenResolver();
