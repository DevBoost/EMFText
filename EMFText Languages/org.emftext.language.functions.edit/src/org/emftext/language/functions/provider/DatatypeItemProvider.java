...
import org.emftext.language.functions.Datatype;
import org.emftext.language.functions.FunctionsFactory;
import org.emftext.language.functions.FunctionsPackage;

/**
 * This is the item provider adapter for a {@link org.emftext.language.functions.Datatype} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DatatypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Datatype_ignored_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Datatype_ignored_feature", "_UI_Datatype_type"),
				 FunctionsPackage.Literals.DATATYPE__IGNORED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FunctionsPackage.Literals.DATATYPE__PROPERTIES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Datatype.class)) {
			case FunctionsPackage.DATATYPE__IGNORED:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FunctionsPackage.DATATYPE__PROPERTIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FunctionsPackage.Literals.DATATYPE__PROPERTIES,
				 FunctionsFactory.eINSTANCE.createProperty()));
	}
