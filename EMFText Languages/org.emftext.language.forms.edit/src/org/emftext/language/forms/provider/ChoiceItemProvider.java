...
/**
 * This is the item provider adapter for a {@link org.emftext.language.forms.Choice} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChoiceItemProvider
	extends ItemTypeItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Choice_multiple_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Choice_multiple_feature", "_UI_Choice_type"),
				 FormsPackage.Literals.CHOICE__MULTIPLE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormsPackage.Literals.CHOICE__OPTIONS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Choice.class)) {
			case FormsPackage.CHOICE__MULTIPLE:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FormsPackage.CHOICE__OPTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormsPackage.Literals.CHOICE__OPTIONS,
				 FormsFactory.eINSTANCE.createOption()));
	}
