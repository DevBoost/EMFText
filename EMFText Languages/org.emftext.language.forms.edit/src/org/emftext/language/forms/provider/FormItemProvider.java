...
/**
 * This is the item provider adapter for a {@link org.emftext.language.forms.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Form_caption_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Form_caption_feature", "_UI_Form_type"),
				 FormsPackage.Literals.FORM__CAPTION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(FormsPackage.Literals.FORM__GROUPS);
		}
	...
	public String getText(Object object) {
		String label = ((Form)object).getCaption();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Form.class)) {
			case FormsPackage.FORM__CAPTION:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case FormsPackage.FORM__GROUPS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(FormsPackage.Literals.FORM__GROUPS,
				 FormsFactory.eINSTANCE.createGroup()));
	}
