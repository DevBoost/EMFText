...
public class MyTransformationExecutor extends TransformationRunner {
	...
	public MyTransformationExecutor(URI transformationURI, 
		...
		rs = createResourceSet(fPackageRegistry);
	...
	public Diagnostic initialize() {
		...
		if(writeTraceFile)
			System.out.println(loadDiagnostic);
