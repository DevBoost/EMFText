...
TOKENSTYLES {
	...
	"BY" COLOR #7F0055, BOLD;
	"HAVING" COLOR #7F0055, BOLD;
	"ORDER" COLOR #7F0055, BOLD;
	...
	"EXISTS" COLOR #7F0055, BOLD;
	"BETWEEN" COLOR #7F0055, BOLD;
	"IN" COLOR #7F0055, BOLD;
	"LIKE" COLOR #7F0055, BOLD;
	"TRUE" COLOR #7F0055, BOLD;
	"FALSE" COLOR #7F0055, BOLD;
	"UNION" COLOR #7F0055, BOLD;
	"MINUS" COLOR #7F0055, BOLD;
	"EXCEPT" COLOR #7F0055, BOLD;
...
RULES {
	...
	sqlDataTypes.Integer ::= "INTEGER";
	sqlDataTypes.Boolean ::= "BOOLEAN";
	sqlDataTypes.Real ::= "REAL";
	sqlDataTypes.String ::= "VARCHAR";
