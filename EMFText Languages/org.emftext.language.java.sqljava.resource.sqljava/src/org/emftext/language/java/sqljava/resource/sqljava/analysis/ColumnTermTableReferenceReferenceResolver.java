...
public class ColumnTermTableReferenceReferenceResolver implements org.emftext.language.java.sqljava.resource.sqljava.ISqljavaReferenceResolver<org.emftext.language.sql.select.term.ColumnTerm, org.emftext.language.sql.select.from.Table> {
	...
	public void resolve(String identifier, org.emftext.language.sql.select.term.ColumnTerm container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.java.sqljava.resource.sqljava.ISqljavaReferenceResolveResult<org.emftext.language.sql.select.from.Table> result) {
		delegate.resolve(identifier, container, reference, position, resolveFuzzy, new org.emftext.language.sql.resource.sql.ISqlReferenceResolveResult<org.emftext.language.sql.select.from.Table>() {
			...
			public java.util.Collection<org.emftext.language.sql.resource.sql.ISqlReferenceMapping<org.emftext.language.sql.select.from.Table>> getMappings() {
