...
/*
 * This class is generated from the entity 'Warehouse' defined in the HEDL model.
 * Note: Any change made to this class will be overridden.
 */
public class Warehouse {
	
	@GenericGenerator(name="WarehouseIdGenerator", strategy="org.hibernate.id.MultipleHiLoPerTableGenerator",
	  parameters = {
	    @Parameter(name="table", value="IdentityGenerator"),
	    @Parameter(name="primary_key_column", value="sequence_name"),
	    @Parameter(name="primary_key_value", value="Warehouse"),
	...
	@Id 
	@GeneratedValue(strategy=GenerationType.TABLE, generator="WarehouseIdGenerator")
	private int id;
