 ...
 * @generated
 */
public class SecpropElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public SecpropElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.SecpropElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "secprop".equals(fileExtension); //$NON-NLS-1$
	}
