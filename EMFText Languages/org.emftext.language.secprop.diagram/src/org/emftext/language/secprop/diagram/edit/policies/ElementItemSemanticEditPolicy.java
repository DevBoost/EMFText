...
import org.emftext.language.secprop.diagram.edit.commands.ChannelCreateCommand;
import org.emftext.language.secprop.diagram.edit.commands.ChannelReorientCommand;
...
public class ElementItemSemanticEditPolicy extends
	...
	public ElementItemSemanticEditPolicy() {
		super(SecpropElementTypes.Element_2001);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (SecpropVisualIDRegistry.getVisualID(incomingLink) == ChannelEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (SecpropVisualIDRegistry.getVisualID(outgoingLink) == ChannelEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (SecpropElementTypes.Channel_4001 == req.getElementType()) {
