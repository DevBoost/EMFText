...
import org.emftext.language.secprop.diagram.part.SecpropDiagramEditor;
 ...
 * @generated
 */
public class SecpropNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof SecpropNavigatorItem) {
					selectedElement = ((SecpropNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (SecPropModelEditPart.MODEL_ID
							.equals(SecpropVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, SecpropDiagramEditor.ID);
