 ...
 * @generated
 */
public class SecpropCreateShortcutDecorationsCommand extends
	 ...
	 * @generated
	 */
	public SecpropCreateShortcutDecorationsCommand(
		...
		for (Iterator it = myDescriptors.iterator(); it.hasNext();) {
			...
			if (view != null && view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				...
				shortcutAnnotation.getDetails().put(
						"modelID", SecPropModelEditPart.MODEL_ID); //$NON-NLS-1$
