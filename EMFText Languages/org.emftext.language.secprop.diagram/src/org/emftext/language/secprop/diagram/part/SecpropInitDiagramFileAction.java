 ...
 * @generated
 */
public class SecpropInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SecpropNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				SecPropModelEditPart.MODEL_ID));
		SecpropDiagramEditorUtil.runWizard(getShell(), wizard,
