...
import org.emftext.language.secprop.diagram.part.SecpropLinkDescriptor;
 ...
 * @generated
 */
public class SecPropModelCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = SecpropDiagramUpdater
				.getSecPropModel_1000SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
	...
	protected boolean isOrphaned(Collection semanticChildren, final View view) {
		if (view.getEAnnotation("Shortcut") != null) { //$NON-NLS-1$
			return SecpropDiagramUpdater.isShortcutOrphaned(view);
		}
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(SecpropPackage.eINSTANCE
					.getSecPropModel_Elements());
			myFeaturesToSynchronize.add(SecpropPackage.eINSTANCE
					.getSecPropModel_Data());
		}
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			int diagramLinkVisualID = SecpropVisualIDRegistry
			...
			for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
					.hasNext();) {
				SecpropLinkDescriptor nextLinkDescriptor = (SecpropLinkDescriptor) linkDescriptorsIterator
						.next();
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		if (!SecPropModelEditPart.MODEL_ID.equals(SecpropVisualIDRegistry
				.getModelID(view))) {
			return Collections.EMPTY_LIST;
		}
		...
		case SecPropModelEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SecpropDiagramUpdater
						.getSecPropModel_1000ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case ElementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SecpropDiagramUpdater
						.getElement_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case DataEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SecpropDiagramUpdater
						.getData_2002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case AccessEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SecpropDiagramUpdater
						.getAccess_3001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case EncryptionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(SecpropDiagramUpdater
						.getEncryption_3002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final SecpropLinkDescriptor nextLinkDescriptor = (SecpropLinkDescriptor) linkDescriptorsIterator
					.next();
