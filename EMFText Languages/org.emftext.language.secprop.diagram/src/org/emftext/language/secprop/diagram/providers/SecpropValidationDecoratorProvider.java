 ...
 * @generated
 */
public class SecpropValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = SecpropDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof SecpropDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& SecPropModelEditPart.MODEL_ID.equals(SecpropVisualIDRegistry
						.getModelID(view));
	}
