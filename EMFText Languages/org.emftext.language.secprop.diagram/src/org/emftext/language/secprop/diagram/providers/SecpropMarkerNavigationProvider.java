 ...
 * @generated
 */
public class SecpropMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = SecpropDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			SecpropDiagramEditorUtil.selectElementsInDiagram(editor, Arrays
