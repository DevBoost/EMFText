...
public class AnnotationAttributeSettingAttributeReferenceResolver implements org.emftext.language.java.reusejava.resource.reusejava.IReusejavaReferenceResolver<org.emftext.language.java.annotations.AnnotationAttributeSetting, org.emftext.language.java.members.InterfaceMethod> {
	...
	public void resolve(String identifier, org.emftext.language.java.annotations.AnnotationAttributeSetting container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, final org.emftext.language.java.reusejava.resource.reusejava.IReusejavaReferenceResolveResult<org.emftext.language.java.members.InterfaceMethod> result) {
		delegate.resolve(identifier, container, reference, position, resolveFuzzy, new org.emftext.language.java.resource.java.IJavaReferenceResolveResult<org.emftext.language.java.members.InterfaceMethod>() {
			...
			public void addQuickFix(final org.emftext.language.java.resource.java.IJavaQuickFix quickFix) {
				result.addQuickFix(new org.emftext.language.java.reusejava.resource.reusejava.IReusejavaQuickFix() {
