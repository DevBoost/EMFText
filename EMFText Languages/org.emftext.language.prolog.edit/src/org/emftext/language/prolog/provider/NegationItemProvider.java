...
import org.emftext.language.prolog.Negation;
import org.emftext.language.prolog.PrologFactory;
import org.emftext.language.prolog.PrologPackage;

/**
 * This is the item provider adapter for a {@link org.emftext.language.prolog.Negation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NegationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PrologPackage.Literals.NEGATION__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PrologPackage.Literals.NEGATION__BODY);
		}
	...
	public String getText(Object object) {
		ADDITIVE_OPERATOR labelValue = ((Negation)object).getOperator();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Negation.class)) {
			case PrologPackage.NEGATION__OPERATOR:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PrologPackage.NEGATION__BODY:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PrologPackage.Literals.NEGATION__BODY,
