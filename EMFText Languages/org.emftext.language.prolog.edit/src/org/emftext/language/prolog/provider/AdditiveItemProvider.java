...
import org.emftext.language.prolog.ADDITIVE_OPERATOR;
import org.emftext.language.prolog.Additive;
import org.emftext.language.prolog.PrologFactory;
import org.emftext.language.prolog.PrologPackage;

/**
 * This is the item provider adapter for a {@link org.emftext.language.prolog.Additive} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AdditiveItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PrologPackage.Literals.ADDITIVE__OPERATOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PrologPackage.Literals.ADDITIVE__LEFT);
			childrenFeatures.add(PrologPackage.Literals.ADDITIVE__RIGHT);
		}
	...
	public String getText(Object object) {
		ADDITIVE_OPERATOR labelValue = ((Additive)object).getOperator();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Additive.class)) {
			case PrologPackage.ADDITIVE__OPERATOR:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case PrologPackage.ADDITIVE__LEFT:
			case PrologPackage.ADDITIVE__RIGHT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PrologPackage.Literals.ADDITIVE__LEFT,
		...
		newChildDescriptors.add
			(createChildParameter
				(PrologPackage.Literals.ADDITIVE__RIGHT,
				 PrologFactory.eINSTANCE.createNumeral()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == PrologPackage.Literals.ADDITIVE__LEFT ||
			childFeature == PrologPackage.Literals.ADDITIVE__RIGHT;
