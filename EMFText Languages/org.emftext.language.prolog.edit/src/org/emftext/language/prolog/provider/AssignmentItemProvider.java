...
import org.emftext.language.prolog.Assignment;
...
/**
 * This is the item provider adapter for a {@link org.emftext.language.prolog.Assignment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AssignmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PrologPackage.Literals.ASSIGNMENT__VARIABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PrologPackage.Literals.ASSIGNMENT__TERM);
		}
	...
	public String getText(Object object) {
		String text = PlResourceUtil.getText((Assignment) object);
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Assignment.class)) {
			case PrologPackage.ASSIGNMENT__TERM:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PrologPackage.Literals.ASSIGNMENT__TERM,
