...
/**
 * This is the item provider adapter for a {@link org.emftext.language.prolog.Clause} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClauseItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PrologPackage.Literals.CLAUSE__PREDICATE);
			childrenFeatures.add(PrologPackage.Literals.CLAUSE__CONJUNCTION);
		}
	...
	public String getText(Object object) {
		String text = PlResourceUtil.getText((Clause) object);
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Clause.class)) {
			...
			case PrologPackage.CLAUSE__CONJUNCTION:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PrologPackage.Literals.CLAUSE__PREDICATE,
				 PrologFactory.eINSTANCE.createPredicate()));

		newChildDescriptors.add
			(createChildParameter
				(PrologPackage.Literals.CLAUSE__CONJUNCTION,
				 PrologFactory.eINSTANCE.createConjunction()));
	}
