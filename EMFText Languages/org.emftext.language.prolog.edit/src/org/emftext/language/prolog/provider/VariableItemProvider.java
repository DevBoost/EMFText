...
/**
 * This is the item provider adapter for a {@link org.emftext.language.prolog.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PrologPackage.Literals.VARIABLE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String text = PlResourceUtil.getText((Variable) object);
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Variable.class)) {
			case PrologPackage.VARIABLE__NAME:
