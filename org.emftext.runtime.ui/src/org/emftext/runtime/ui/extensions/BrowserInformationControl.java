...
public class BrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private DocBrowserInformationControlInput fInput;
	 ...
	 * {@link DocBrowserInformationControlInput}.
	 */
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof DocBrowserInformationControlInput);
		...
		fInput= (DocBrowserInformationControlInput)input;
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = HTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public DocBrowserInformationControlInput getInput() {
		return fInput;
	}
