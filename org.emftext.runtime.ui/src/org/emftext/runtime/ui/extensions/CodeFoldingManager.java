...
public class CodeFoldingManager {
	...
	/**
	 * Try to add this Position to the model. If a Position existed on the same line, the longer one will be chosen. 
	 * The Position will be exchanged if it is in the additions, when the to be deleted Annotation existed in deletions. 
	 * Else, just exchange the Position in additions, if there is a shorter one.
	 * Should be tested in JUnit.
	 * @param p
	 */
