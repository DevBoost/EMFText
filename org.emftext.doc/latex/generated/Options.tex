EMFText currently supports 215 code generation options. However, most of them (181) are only used to specify which generated artifacts shall be customized. Subsequently, a list of all options and their description can be found.
