...
public class EObjectUtilGenerator extends JavaBaseGenerator<Object> {
	...
	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new EObjectUtilGenerator());

	private EObjectUtilGenerator() {
		super();
	}

	private EObjectUtilGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceArtifacts.E_OBJECT_UTIL);
	}
