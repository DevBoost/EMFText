...
public class ListUtilGenerator extends JavaBaseGenerator<Object> {

	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new ListUtilGenerator());

	private ListUtilGenerator() {
		super();
	}

	private ListUtilGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceArtifacts.LIST_UTIL);
	}
