...
public class DelegatingResolveResultGenerator extends JavaBaseGenerator<Object> {
	...
	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new DelegatingResolveResultGenerator());
	
	private DelegatingResolveResultGenerator() {
		super();
	}

	private DelegatingResolveResultGenerator(ICodeGenerationComponent parent, GenerationContext context) {
	...
	public IGenerator<GenerationContext, Object> newInstance(ICodeGenerationComponent parent, GenerationContext context, Object parameters) {
		return new DelegatingResolveResultGenerator(parent, context);
	}
}
