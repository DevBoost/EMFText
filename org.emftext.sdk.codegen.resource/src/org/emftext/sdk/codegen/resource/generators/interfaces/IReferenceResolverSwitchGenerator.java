...
public class IReferenceResolverSwitchGenerator extends JavaBaseGenerator<Object> {
	...
	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new IReferenceResolverSwitchGenerator());

	private IReferenceResolverSwitchGenerator() {
		super();
	}

	private IReferenceResolverSwitchGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceArtifacts.I_REFERENCE_RESOLVER_SWITCH);
	}
