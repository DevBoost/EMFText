...
public class StreamUtilGenerator extends JavaBaseGenerator<Object> {
	...
	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new StreamUtilGenerator());

	private StreamUtilGenerator() {
		super();
	}

	private StreamUtilGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceArtifacts.STREAM_UTIL);
	}
