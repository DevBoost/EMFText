...
public class IResourcePostProcessorGenerator extends JavaBaseGenerator<Object> {
	...
	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new IResourcePostProcessorGenerator());

	private IResourcePostProcessorGenerator() {
		super();
	}

	private IResourcePostProcessorGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceArtifacts.I_RESOURCE_POST_PROCESSOR);
	}

	public IGenerator<GenerationContext, Object> newInstance(ICodeGenerationComponent parent, GenerationContext context, Object parameters) {
		return new IResourcePostProcessorGenerator(parent, context);
	}
