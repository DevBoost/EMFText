...
public class UnicodeConverterGenerator extends JavaBaseGenerator<Object> {
	...
	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new UnicodeConverterGenerator());

	private UnicodeConverterGenerator() {
		super();
	}

	private UnicodeConverterGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceArtifacts.UNICODE_CONVERTER);
	}
