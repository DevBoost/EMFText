...
public class TerminateParsingExceptionGenerator extends JavaBaseGenerator<Object> {
	...
	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new TerminateParsingExceptionGenerator());

	private TerminateParsingExceptionGenerator() {
		super();
	}

	private TerminateParsingExceptionGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceArtifacts.TERMINATE_PARSING_EXCEPTION);
	}
