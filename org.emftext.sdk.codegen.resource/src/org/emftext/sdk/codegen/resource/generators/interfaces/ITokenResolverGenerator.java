...
public class ITokenResolverGenerator extends JavaBaseGenerator<Object> {
	...
	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new ITokenResolverGenerator());

	private ITokenResolverGenerator() {
		super();
	}

	private ITokenResolverGenerator(ICodeGenerationComponent parent, GenerationContext context) {
		super(parent, context, TextResourceArtifacts.I_TOKEN_RESOLVER);
	}
