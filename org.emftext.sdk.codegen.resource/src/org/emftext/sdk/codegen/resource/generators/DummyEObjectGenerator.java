...
public class DummyEObjectGenerator extends JavaBaseGenerator<Object> {

	public final static GeneratorProvider<GenerationContext, Object> PROVIDER = 
		new GeneratorProvider<GenerationContext, Object>(new DummyEObjectGenerator());
	
	private DummyEObjectGenerator() {
		super();
	}

	private DummyEObjectGenerator(ICodeGenerationComponent parent, GenerationContext context) {
	...
	public IGenerator<GenerationContext, Object> newInstance(ICodeGenerationComponent parent, GenerationContext context, Object parameters) {
		return new DummyEObjectGenerator(parent, context);
	}
}
