...
public abstract class AbstractPluginCreator<ParameterType> extends AbstractGenerationComponent implements ICreator<GenerationContext, ParameterType> {

	public void generate(IPluginDescriptor plugin, GenerationContext context, ParameterType parameters, IProgressMonitor monitor) throws IOException {
