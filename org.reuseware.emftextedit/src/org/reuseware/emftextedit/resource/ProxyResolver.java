...
public interface ProxyResolver {
	...
	/**
	 * Attempts to resolves a proxy object.
	 * 
	...
	/**
	 * Attempts to resolves a proxy object. This method should reports all errors.
	 * 
	 * @param proxy The proxy.
	 * @param container The object referencing the proxy.
	 * @param reference The reference that holds the proxy.
	...
	/**
	 * Reverse of the resolve operation: constructs a representing proxiURI of the given
	 * object.
	 * 
	 ...
	 * @param resource  The resource containing the element. 
