...
import org.reuseware.emftextedit.codegen.TextParserGenerator.InternalTokenDefinition;
 ...
 * 
 * @see org.reuseware.emftextedit.resource.impl.BasicTokenResolverFactory
 * 
 * @author skarol
 *
 */
...
public class TokenResolverFactoryGenerator extends BaseGenerator {
	...
	public boolean generate(PrintWriter out) {
		...
		out.println();
		out.println("import org.reuseware.emftextedit.resource.TokenResolverFactory;");
		out.println("import org.reuseware.emftextedit.resource.impl.BasicTokenResolverFactory;");
		out.println();
