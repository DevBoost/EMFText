...
public class ColorManagerCreator extends AbstractArtifactCreator {

	private static final String NAME = "ColorManager";

	public ColorManagerCreator() {
		super(NAME);
	}
	...
	public Collection<IArtifact> getArtifactsToCreate(GenerationContext context) {
		...
		File file = context.getFile(EArtifact.COLOR_MANAGER);
		IGenerator generator = new ColorManagerGenerator(context);
	...
	public OptionTypes getOverrideOption() {
		return OptionTypes.OVERRIDE_COLOR_MANAGER;
	}
}
