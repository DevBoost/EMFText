...
public class BracketSetCreator extends AbstractArtifactCreator {

	private static final String NAME = "BracketSet";

	public BracketSetCreator() {
		super(NAME);
	}
	...
	public Collection<IArtifact> getArtifactsToCreate(GenerationContext context) {
		...
		File file = context.getFile(EArtifact.BRACKET_SET);
		IGenerator generator = new BracketSetGenerator(context);
	...
	public OptionTypes getOverrideOption() {
		return OptionTypes.OVERRIDE_BRACKET_SET;
	}
}
