...
public class PositionHelperCreator extends AbstractArtifactCreator {

	private static final String NAME = "PositionHelper";

	public PositionHelperCreator() {
		super(NAME);
	}
	...
	public Collection<IArtifact> getArtifactsToCreate(GenerationContext context) {
		...
		File file = context.getFile(EArtifact.POSITION_HELPER);
		IGenerator generator = new PositionHelperGenerator(context);
	...
	public OptionTypes getOverrideOption() {
		return OptionTypes.OVERRIDE_POSITION_HELPER;
	}
}
