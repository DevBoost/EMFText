...
public class HighlightingCreator extends AbstractArtifactCreator {

	private static final String NAME = "Highlighting";

	public HighlightingCreator() {
		super(NAME);
	}
	...
	public Collection<IArtifact> getArtifactsToCreate(GenerationContext context) {
		...
		File file = context.getFile(EArtifact.HIGHLIGHTING);
		IGenerator generator = new HighlightingGenerator(context);
	...
	public OptionTypes getOverrideOption() {
		return OptionTypes.OVERRIDE_HIGHLIGHTING;
	}
}
