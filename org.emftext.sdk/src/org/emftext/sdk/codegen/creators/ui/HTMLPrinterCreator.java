...
public class HTMLPrinterCreator extends AbstractArtifactCreator {

	private static final String NAME = "HTMLPrinter";

	public HTMLPrinterCreator() {
		super(NAME);
	}
	...
	public Collection<IArtifact> getArtifactsToCreate(GenerationContext context) {
		...
		File file = context.getFile(EArtifact.HTML_PRINTER);
		IGenerator generator = new HTMLPrinterGenerator(context);
	...
	public OptionTypes getOverrideOption() {
		return OptionTypes.OVERRIDE_HTML_PRINTER;
	}
}
