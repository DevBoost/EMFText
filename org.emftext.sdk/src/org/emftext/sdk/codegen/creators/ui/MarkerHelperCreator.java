...
public class MarkerHelperCreator extends AbstractArtifactCreator {

	private static final String NAME = "MarkerHelper";

	public MarkerHelperCreator() {
		super(NAME);
	}
	...
	public Collection<IArtifact> getArtifactsToCreate(GenerationContext context) {
		...
		File file = context.getFile(EArtifact.MARKER_HELPER);
		IGenerator generator = new MarkerHelperGenerator(context);
	...
	public OptionTypes getOverrideOption() {
		return OptionTypes.OVERRIDE_MARKER_HELPER;
	}
}
