...
public class BracketPreferencePageGenerator extends BaseGenerator {
	...
	public boolean generate(PrintWriter out) {
		...
		sc.add("private " + LIST + " bracketsList;");
		...
		sc.add("bracketSetTemp.put(languageID, getPreferenceStore().getString(");
		sc.add("languageID + PreferenceConstants.EDITOR_BRACKETS_SUFFIX));");
		sc.add("}");
		sc.add("}");
		sc.addLineBreak();
		sc.add("@Override");
		...
		sc.addLineBreak();
		sc.add("bracketsList = new " + LIST + "(tokenSelectionComposite, " + SWT + ".MULTI);");
		...
		sc.add("PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));");
		...
		sc.add("language + PreferenceConstants.EDITOR_BRACKETS_SUFFIX));");
		...
		sc.add("getPreferenceStore().setValue(PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());");
		sc.addLineBreak();
