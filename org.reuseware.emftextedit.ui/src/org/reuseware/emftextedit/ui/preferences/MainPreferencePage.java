...
public class MainPreferencePage extends FieldEditorPreferencePage implements
	...
	protected void createFieldEditors() {
		...
		BooleanFieldEditor genTestAction = new BooleanFieldEditor(EMFTextEditUIPlugin.GENERATE_TEST_ACTION_NAME, "&Contribute Test Action",BooleanFieldEditor.DEFAULT, platformGeneratorGroup);
		BooleanFieldEditor ovrPluginConfig = new BooleanFieldEditor(EMFTextEditUIPlugin.OVERRIDE_PLUGIN_CONFIG_NAME, "&Allways Override 'plugin.xml' and 'MANIFEST.MF'",BooleanFieldEditor.DEFAULT, platformGeneratorGroup);
		BooleanFieldEditor genGenModel = new BooleanFieldEditor(EMFTextEditUIPlugin.GENERATE_GEN_MODEL, "&Auto-generate GenModel from Ecore",BooleanFieldEditor.DEFAULT, platformGeneratorGroup);
