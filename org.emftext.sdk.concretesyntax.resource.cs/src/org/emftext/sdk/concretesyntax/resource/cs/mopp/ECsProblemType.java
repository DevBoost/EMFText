...
public enum ECsProblemType {
	...
	TOKEN_PRIORIZATION_USELESS_WHEN_TOKEN_SORTING_ENABLED(CsEProblemType.WARNING), 
	...
	BOOLEAN_TERMINAL_FEATURE_NOT_ATTRIBUTE(CsEProblemType.ERROR), 
	BOOLEAN_TERMINAL_FEATURE_NOT_BOOLEAN(CsEProblemType.ERROR),
	BOOLEAN_TERMINAL_WRONG_FEATURE_UPPER_BOUND(CsEProblemType.ERROR),
	BOOLEAN_TERMINAL_BOTH_LITERALS_EMPTY(CsEProblemType.ERROR),
	BOOLEAN_TERMINAL_EQUAL_LITERALS(CsEProblemType.ERROR),
	BOOLEAN_TERMINAL_ANONYMOUS_FEATURE(CsEProblemType.ERROR), 
	OPERATOR_ANNOTATION_IS_MISSING_PROPERTY(CsEProblemType.ERROR), 
	OPERATOR_ANNOTATION_INVALID_PROPERTY(CsEProblemType.ERROR), 
	OPERATOR_ANNOTATION_MALFORMED_RULE(CsEProblemType.ERROR), 
	INVALID_START_SYMBOL(CsEProblemType.ERROR),
	NO_SYNTAX_FOR_CONTAINMENT_REFERENCE(CsEProblemType.ERROR),
	;
