...
public class GeneratorconfigOccurrence {
	...
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigTokenScanner tokenScanner;
	...
	//
	public GeneratorconfigOccurrence(org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;

		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigMetaInformation().getTokenNames();
	...
	public void handleOccurrenceHighlighting(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBracketSet bracketSet) {
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addPosition(document, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.DEFINTION.toString());
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if ((isNull && elementsAtDefinition.contains(occEO)) || !isNull && definitionElement.equals(occEO)) {
						addPosition(document, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPositionCategory.PROXY.toString());
					}
				}
			}
			token = tokenScanner.nextToken();
