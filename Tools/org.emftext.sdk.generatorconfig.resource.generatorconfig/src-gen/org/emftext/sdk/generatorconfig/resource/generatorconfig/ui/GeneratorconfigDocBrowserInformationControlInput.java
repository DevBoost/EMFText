...
public class GeneratorconfigDocBrowserInformationControlInput {

	private final GeneratorconfigDocBrowserInformationControlInput fPrevious;
	private GeneratorconfigDocBrowserInformationControlInput fNext;
	...
	///
	public GeneratorconfigDocBrowserInformationControlInput(GeneratorconfigDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	...
	public GeneratorconfigDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	...
	public GeneratorconfigDocBrowserInformationControlInput getNext() {
		return fNext;
	}
