...
public class GeneratorconfigNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	...
	//
	// @param pageName
	public GeneratorconfigNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new generatorconfig file");
