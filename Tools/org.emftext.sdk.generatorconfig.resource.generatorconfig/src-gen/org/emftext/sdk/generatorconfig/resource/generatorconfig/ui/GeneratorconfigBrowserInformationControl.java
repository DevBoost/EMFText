...
// @since 3.2
///
public class GeneratorconfigBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput fInput;
	...
	public GeneratorconfigBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public GeneratorconfigBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public GeneratorconfigBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput) input;
		...
		org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput getInput() {
		return fInput;
	}
