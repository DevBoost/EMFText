...
public class GeneratorconfigHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public GeneratorconfigHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor) {
					org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor emftEditor = (org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor) editorPart;
