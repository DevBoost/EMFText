...
//
public class GeneratorconfigTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBrowserInformationControl infoControl) {
		...
		public void run() {
			org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput infoInput = (org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHyperlink hyperlink = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBrowserInformationControl iControl = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput) {
							org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput input = (org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBrowserInformationControl.isAvailable(parent)) {
				org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBrowserInformationControl iControl = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public GeneratorconfigTextHover(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigMetaInformation().getHoverTextProvider();
	}

	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource textResource = editor.getResource();
	...
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigTextHover.getStyleSheet());
			org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.PLUGIN_ID);
