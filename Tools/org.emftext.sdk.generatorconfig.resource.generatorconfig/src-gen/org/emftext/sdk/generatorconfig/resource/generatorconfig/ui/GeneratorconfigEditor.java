...
//
// A text editor for 'generatorconfig' models.
//
public class GeneratorconfigEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {

	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigCodeFoldingManager codeFoldingManager;
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBackgroundParsingStrategy bgParsingStrategy = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBackgroundParsingListener>();
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigColorManager colorManager = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigColorManager();
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigOutlinePage outlinePage;
	...
	private org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPropertySheetPage propertySheetPage;
	...
	public GeneratorconfigEditor() {
		...
		setSourceViewerConfiguration(new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), GeneratorconfigEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource currentResource = getResource();
				...
				org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource loadedResource = (org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource) {
					setResource((org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the GeneratorconfigEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource textResource = (org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource) element.eResource();
			...
			org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextToken token = lexer.getNextToken();
			...
			org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}

	public void notifyBackgroundParsingFinished() {
		for (org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigMarkerHelper.unmark(resourceToRefresh);
						org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}
