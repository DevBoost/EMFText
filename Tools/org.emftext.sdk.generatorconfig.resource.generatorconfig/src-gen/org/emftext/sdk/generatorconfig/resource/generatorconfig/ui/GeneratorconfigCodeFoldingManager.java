...
public class GeneratorconfigCodeFoldingManager {

	private class FoldingUpdateListener implements org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor) {
				org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor editor = (org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor) workbenchPart;
	...
	protected org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor editor;
	...
	public GeneratorconfigCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.sdk.generatorconfig.resource.generatorconfig.ui.GeneratorconfigEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.sdk.generatorconfig.resource.generatorconfig.mopp.GeneratorconfigPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource textResource = (org.emftext.sdk.generatorconfig.resource.generatorconfig.IGeneratorconfigTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
