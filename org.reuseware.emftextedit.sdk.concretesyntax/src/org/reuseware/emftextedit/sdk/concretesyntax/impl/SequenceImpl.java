 ...
 * <ul>
 *   <li>{@link org.reuseware.emftextedit.sdk.concretesyntax.impl.SequenceImpl#getParts <em>Parts</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SequenceImpl extends EObjectImpl implements Sequence {
	 ...
	 * @ordered
	 */
	protected EList<Definition> parts;
	...
	public EList<Definition> getParts() {
		if (parts == null) {
			parts = new EObjectContainmentEList<Definition>(Definition.class, this, ConcretesyntaxPackage.SEQUENCE__PARTS);
		}
		return parts;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ConcretesyntaxPackage.SEQUENCE__PARTS:
				getParts().clear();
				getParts().addAll((Collection<? extends Definition>)newValue);
				return;
		}
